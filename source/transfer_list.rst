...
- Project Specific Entries (:numref:`project_specific_entries`).
...
.. _project_specific_entries:

Project Specific Transfer Entries
---------------------------------

This specification defines generic and widely applicable TEs.
There are TEs relevant to a unique software/firmware project, or small set of those.
These project specific TEs are defined in an ancillary specification [FWH_Project_Entries]_.

The following tag ID ranges are used by that specification.

.. _tab_entries_summary:
.. list-table:: List of tag ID ranges in the Project Specific Entries ancillary specification
   :header-rows: 1
